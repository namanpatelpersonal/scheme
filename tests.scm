...
((lambda (x y) (* x y (((double x (* 2 x)) 3)))) 2 4)
; expect 48
...
(cond ((= (2+3) (- 6 2)) 'bye) ((= 3 (2+1)) 'hello) (else 'anti))
; expect hello

(cond ((= (2) (+ 1 3)) 'bye) ((= 3 (2+5)) 'hello) (else 'pure))
; expect pure

(if (= 40 (* 4 10)) (- 30 10) (/ 100 10))
; expect 20

(if (= 10 (* 5 (+ 1 2))) (+ 55 10) (/ 50 5))
; expect 10

(define x 10)
; expect x

(define y 'computerscience)
; expect y
...
(list x y)
; expect (10 computerscience)

(define process1 (mu () (/ (* a b) (+ a b))))
; expect process1

(define process2 (lambda () (define a 5) (define b 20) (process1)))
; expect process2
...
; expect ((0 10) (1 20) (2 30) (3 40))

(enumerate '(-1 'hello -3))
; expect ((0 -1) (1 hello) (2 -3))
; END PROBLEM 0
